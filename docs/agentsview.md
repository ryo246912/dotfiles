...
| `google_artifact_registry_repository.agentsview`        | `us-west2`、Docker format                       | AgentsView container imageを保存するrepository。ECR repositoryに相当する。cleanup policyで直近10 versionを残し、30日より古いものを消す（無料枠0.5 GB対策）  |
