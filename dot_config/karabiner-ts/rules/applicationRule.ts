...
// annotation
const shouldAnnotation = map("f1", "left_option")
    .to("japanese_eisuu")
    .to("close_bracket")
    .to("s")
    .to("h")
...
const optionalAnnotation = map("f2", "left_option")
    .to("japanese_eisuu")
    .to("close_bracket")
    .to("o")
    .to("p")
...
const imoAnnotation = map("f3", "left_option")
    .to("japanese_eisuu")
    .to("close_bracket")
    .to("i")
    .to("m")
...
const qAnnotation = map("f4", "left_option")
    .to("japanese_eisuu")
    .to("close_bracket")
    .to("q", "left_shift")
    .to("backslash")

const memoAnnotation = map("f5", "left_option")
    .to("japanese_eisuu")
    .to("close_bracket")
    .to("m")
    .to("e")
...
const mustAnnotation = map("f6", "left_option")
    .to("japanese_eisuu")
    .to("close_bracket")
    .to("m")
    .to("u")
